-- Generate next-month obligation tasks automatically on the 25th of each month.
-- This is intentionally database-owned so it does not depend on any user opening the app.
