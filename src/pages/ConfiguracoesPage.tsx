...
export default function ConfiguracoesPage() {
  ...
  const changePassword = async () => {
    ...
    if (securityForm.newPassword !== securityForm.confirmPassword) return toast.error("Confirmação da senha invalida.");
  ...
  return (
    <AppLayout>
      <div className="space-y-6 max-w-5xl">
        <div><h1 className="font-heading text-2xl font-bold">Configuracoes</h1><p className="text-sm text-muted-foreground">Gerencie seu perfil e preferências do sistema</p></div>
