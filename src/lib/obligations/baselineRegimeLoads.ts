...
export const baselineRegimeLoads: BaselineRegimeLoad[] = [
  {
    ...
    items: [
      ...
      item("municipal_service_tax_return", "conditional", 50, "iss_applicable"),
      item("icms_state_routine", "conditional", 60, "icms_taxpayer"),
      item("destda", "conditional", 70, "icms_taxpayer"),
      item("fgts", "conditional", 80, "has_employees"),
      item("esocial", "conditional", 90, "has_employees"),
      item("dctfweb_mit", "conditional", 100, "has_employees"),
      item("payroll_closing", "conditional", 110, "has_employees"),
      item("efd_reinf", "conditional", 120, "service_provider"),
      item("accounting_monthly_closing", "conditional", 130, "accounting_contracted"),
      item("tax_regularidade_review", "required", 140),
      item("client_document_checklist", "required", 150),
      item("annual_cadastral_fiscal_review", "required", 160),
      item("simples_option_status_review", "required", 170),
    ],
  },
  {
    ...
    items: [
      ...
      item("municipal_service_tax_return", "conditional", 110, "iss_applicable"),
      item("fgts", "conditional", 120, "has_employees"),
      item("esocial", "conditional", 130, "has_employees"),
      item("payroll_closing", "conditional", 140, "has_employees"),
      item("inss_contribution_review", "conditional", 150, "has_employees"),
      item("tax_withholding_review", "conditional", 160, "service_provider"),
  ...
  },
  {
    ...
    items: [
      ...
      item("inss_contribution_review", "conditional", 150, "has_employees"),
      item("tax_withholding_review", "conditional", 160, "service_provider"),
      item("lalur_lacs_review", "required", 170),
      item("tax_regularidade_review", "required", 180),
      item("client_document_checklist", "required", 190),
      item("accounting_monthly_closing", "required", 200),
      item("annual_cadastral_fiscal_review", "required", 210),
    ],
  },
  {
    taxRegimeCode: "mei",
    ...
    items: [
      ...
      item("iss_municipal", "conditional", 40, "iss_applicable"),
      item("municipal_service_tax_return", "conditional", 50, "iss_applicable"),
      item("mei_status_limit_review", "required", 60),
      item("fgts", "conditional", 70, "has_employees"),
      item("esocial", "conditional", 80, "has_employees"),
      item("dctfweb_mit", "conditional", 90, "has_employees"),
      item("payroll_closing", "conditional", 100, "has_employees"),
      item("mei_migration_alert", "optional", 110),
      item("client_document_checklist", "required", 120),
      item("annual_cadastral_fiscal_review", "required", 130),
    ],
  },
];
