...
export function SiteWhatsAppButton() {
  return (
    <a
      ...
      className="group fixed bottom-24 right-4 z-50 inline-flex h-12 w-12 items-center justify-center rounded-full border border-border/70 bg-background/90 text-foreground shadow-[0_14px_30px_-20px_rgba(10,16,30,0.7)] backdrop-blur transition-all hover:-translate-y-0.5 hover:shadow-[0_18px_34px_-18px_rgba(10,16,30,0.72)] sm:bottom-24 sm:right-6 md:bottom-6"
